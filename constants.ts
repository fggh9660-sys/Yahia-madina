...
export const BRIDGE_WIND = {
  ...
  X_DRIFT_MAX: 80,
  BANNER_SPAWN_INTERVAL_MS: 700,
  BANNER_FLAG_COLOR: 0xc9302c,
  DUST_PARTICLE_EMIT_MS: 50,
  DUST_PARTICLE_LIFESPAN_MS: 800,
  DUST_PARTICLE_SPEED_X_MIN: -640,
  DUST_PARTICLE_SPEED_X_MAX: -440,
  OVERLAY_COLOR: 0x4a4742,
  OVERLAY_ALPHA: 0.55,
  OVERLAY_HEIGHT: 10,
  ENTRY_SHAKE_MS: 140,
  ENTRY_SHAKE_INTENSITY: 0.006,
  ENTRY_HITSTOP_MS: 140,
  ENTRY_HITSTOP_SCALE: 0.55,
};
