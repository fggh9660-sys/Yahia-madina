...
export const BRIDGE_WIND = {
  ...
  DUST_PARTICLE_EMIT_MS: 35,
  DUST_PARTICLE_LIFESPAN_MS: 900,
  DUST_PARTICLE_SPEED_X_MIN: -720,
  DUST_PARTICLE_SPEED_X_MAX: -480,
  TINT_COLOR: 0x1a2e4a,
  TINT_ALPHA: 0.22,
  OVERLAY_COLOR: 0x6b5a4a,
  OVERLAY_ALPHA: 0.85,
  OVERLAY_HEIGHT: 36,
  ENTRY_PILLAR_HEIGHT: 140,
  ENTRY_PILLAR_WIDTH: 24,
  ENTRY_SHAKE_MS: 260,
  ENTRY_SHAKE_INTENSITY: 0.012,
  ENTRY_HITSTOP_MS: 220,
